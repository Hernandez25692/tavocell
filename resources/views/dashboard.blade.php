...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8 px-4 sm:px-6">
    <div class="max-w-7xl mx-auto animate-fade-in">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <!-- Ingresos del Día -->
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <!-- Facturas Emitidas -->
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex items-center justify-between">
                    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('facturas_productos.create') }}" class="bg-white rounded-xl shadow-md p-4 flex items-center justify-center flex-col text-center group transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-blue-50">
            ...
            <a href="{{ route('reparaciones.create') }}" class="bg-white rounded-xl shadow-md p-4 flex items-center justify-center flex-col text-center group transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-yellow-50">
                <div class="bg-yellow-100 text-yellow-600 p-3 rounded-full mb-3 group-hover:bg-yellow-200 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('clientes.create') }}" class="bg-white rounded-xl shadow-md p-4 flex items-center justify-center flex-col text-center group transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-green-50">
                <div class="bg-green-100 text-green-600 p-3 rounded-full mb-3 group-hover:bg-green-200 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('cierres.index') }}" class="bg-white rounded-xl shadow-md p-4 flex items-center justify-center flex-col text-center group transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-purple-50">
