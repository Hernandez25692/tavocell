                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div id="sugerencias-productos"
                            class="hidden mt-1 border border-gray-200 rounded bg-white shadow max-h-40 overflow-y-auto">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 p-4 border border-gray-200 rounded-lg">
                        ...
                        <div class="mt-4 text-right">
                            <button type="button" onclick="limpiarCarrito()"
                                class="mr-2 bg-gray-200 text-gray-800 px-4 py-2 rounded hover:bg-gray-300">Limpiar</button>
                            <button type="button" onclick="mostrarResumen()"
                                class="bg-indigo-600 text-white px-6 py-2 rounded hover:bg-indigo-700">Facturar</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="modal-pago" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center z-50">
            <div class="bg-white rounded-lg p-6 shadow-lg w-full max-w-lg">
                ...
                <div class="mb-2">
                    ...
                    <input type="number" id="monto-recibido" class="form-control w-full" step="0.01"
                        oninput="actualizarCambio()">
                </div>
                <div class="mb-4">
                    <label>Cambio:</label>
                    <input type="text" id="monto-cambio" readonly class="form-control w-full bg-gray-100 font-bold"
                        value="L. 0.00">
                </div>
