        ...
        <form id="factura-form" method="POST" action="{{ route('facturas.store') }}">
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-2">
                    <input type="text" id="codigo-producto" class="form-control flex-grow"
            ...
            <div class="mt-4 text-right">
                ...
                <input type="text" id="total-pagar" class="form-control bg-gray-100 font-bold text-lg text-green-700"
                    readonly value="L. 0.00">
            </div>
    ...
    <div id="modal-pago" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-lg mx-auto">
            ...
            <div class="mb-3">
                ...
                <input type="number" id="monto-recibido" class="form-control" step="0.01" oninput="actualizarCambio()">
            </div>

            <div class="mb-3">
                <label>Cambio:</label>
                <input type="text" id="monto-cambio" class="form-control bg-gray-100 font-bold" readonly value="L. 0.00">
            </div>
